...
public final class VisibilityConfig extends AbstractSafeParcelable {
     ...
     *
     * @param visibilityDocument a {@link GenericDocument} holding all visibility properties other
     *     than publiclyVisibleTargetPackage.
     * @param publicAclDocument a {@link GenericDocument} holding the publiclyVisibleTargetPackage
     *     visibility property
     */
    @NonNull
    public static VisibilityConfig createVisibilityConfig(
        ...
        List<String> visibleToPackageNames =
                Arrays.asList(
        ...
        if (publicAclDocument != null) {
            ...
            publiclyVisibleTargetPackageSha =
                    publicAclDocument.getPropertyBytes(
                            PUBLICLY_VISIBLE_TARGET_PACKAGE_SHA_256_CERT);
        }
    ...
    public List<PackageIdentifier> getVisibleToPackages() {
        ...
        for (int i = 0; i < mVisibleToPackageNames.size(); i++) {
            visibleToPackage.add(
                    new PackageIdentifier(
                            mVisibleToPackageNames.get(i), mVisibleToPackageSha256Certs[i]));
        }
     ...
     * this {@link VisibilityConfig} represents.
     */
    @NonNull
    ...
    public GenericDocument createVisibilityDocument() {
        ...
        builder.setPropertyBytes(
                VISIBLE_TO_PACKAGE_SHA_256_CERT_PROPERTY, mVisibleToPackageSha256Certs);
    ...
    /**
     * Returns the {@link GenericDocument} for the public acl overlay schema if it is provided, null
     * otherwise.
     */
    @Nullable
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(mSchemaType, that.mSchemaType)
                ...
                && Arrays.deepEquals(
                        mVisibleToPackageSha256Certs, that.mVisibleToPackageSha256Certs)
    ...
    public static final class Builder {
         ...
         *     VisibilityConfig} represents. The package and database prefix will be added in server
         *     side. We are using prefixed schema type to be the final id of this {@link
        ...
        public Builder setVisibleToPermissions(@NonNull Set<Set<Integer>> visibleToPermissions) {
            ...
            mRequiredPermissions = new VisibilityPermissionConfig[visibleToPermissions.size()];
            int i = 0;
