...
public final class ExecuteAppFunctionRequest extends AbstractSafeParcelable implements Parcelable  {
    ...
    public static final class Builder {
        ...
        /**
         * Sets parameters for invoking the app function. Keys in the document represent parameter
         * names, and corresponding values represent parameter values.
         */
        @NonNull
        public Builder setParameters(@Nullable GenericDocument parameters) {
        ...
        public ExecuteAppFunctionRequest build() {
            return new ExecuteAppFunctionRequest(
                    mPackageName,
                    mFunctionIdentifier,
                    mParameters == null ? GenericDocument.EMPTY : mParameters,
