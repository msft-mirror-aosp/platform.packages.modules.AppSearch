 ...
 * assets.
 */
public class AppFunctionStaticMetadataParser {
     ...
     */
    public AppFunctionStaticMetadataParser(
    ...
    private List<AppFunctionStaticMetadata> parseAppFunctions(
        ...
        while (eventType != XmlPullParser.END_DOCUMENT) {
            ...
            if (eventType == XmlPullParser.START_TAG && "appfunction".equals(tagName)) {
    ...
    private AppFunctionStaticMetadata parseAppFunction(
        ...
        int eventType = parser.getEventType();
        while (!(eventType == XmlPullParser.END_TAG && "appfunction".equals(parser.getName()))) {
