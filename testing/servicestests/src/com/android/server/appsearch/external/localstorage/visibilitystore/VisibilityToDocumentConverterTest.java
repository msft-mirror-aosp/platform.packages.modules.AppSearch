...
public class VisibilityToDocumentConverterTest {
    ...
    public void testToGenericDocuments() throws Exception {
        ...
        SetSchemaRequest setSchemaRequest =
                new SetSchemaRequest.Builder()
                        ...
                        .setPubliclyVisibleSchema(
                                "someSchema", new PackageIdentifier("com.example.test4", cert4))
        ...
        VisibilityConfigProto visibleToConfigProto =
                VisibilityConfigProto.newBuilder()
                        .addVisibleToPackages(
                                PackageIdentifierProto.newBuilder()
                                        .setPackageName("com.example.test1")
                                        .setPackageSha256Cert(ByteString.copyFrom(cert1))
                                        .build())
                        .setPubliclyVisibleTargetPackage(
                                PackageIdentifierProto.newBuilder()
                                        .setPackageName("com.example.test2")
                                        .setPackageSha256Cert(ByteString.copyFrom(cert2))
                                        .build())
                        .addVisibleToPermissions(
                                VisibleToPermissionProto.newBuilder()
                                        .addAllPermissions(ImmutableSet.of(1, 2))
                                        .build())
                        .build();
        VisibilityConfigProto visibilityConfigProto =
                VisibilityConfigProto.newBuilder()
                        .setPubliclyVisibleTargetPackage(
                                PackageIdentifierProto.newBuilder()
                                        .setPackageName("com.example.test4")
                                        .setPackageSha256Cert(ByteString.copyFrom(cert4))
                                        .build())
                        .build();
        AndroidVOverlayProto overlayProto =
        ...
        GenericDocument expectedAndroidVOverlay =
                new GenericDocument.Builder<GenericDocument.Builder<?>>(
                                "androidVOverlay", "someSchema", "AndroidVOverlayType")
                        .setCreationTimestampMillis(0)
                        .setPropertyBytes(
                                "visibilityProtoSerializeProperty", overlayProto.toByteArray())
                        .build();
        ...
        assertThat(expectedVisibilityDocument)
                .isEqualTo(
                        VisibilityToDocumentConverter.createVisibilityDocument(visibilityConfig));
        assertThat(expectedAndroidVOverlay)
    ...
    public void testToVisibilityConfig() throws Exception {
        ...
        InternalVisibilityConfig modifiedConfig =
    ...
    public void testToGenericDocumentAndBack() {
        ...
        SetSchemaRequest setSchemaRequest =
                new SetSchemaRequest.Builder()
                        ...
                        .setPubliclyVisibleSchema(
                                "someSchema", new PackageIdentifier("com.example.test7", cert7))
