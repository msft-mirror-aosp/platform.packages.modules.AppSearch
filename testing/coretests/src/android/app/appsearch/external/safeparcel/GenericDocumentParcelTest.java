...
public class GenericDocumentParcelTest {
    ...
    public void testGenericDocumentParcel_buildFromAnotherDocumentParcelCorrectly() {
        ...
        assertThat(genericDocumentParcelCopy.getParentTypes())
                .isEqualTo(genericDocumentParcel.getParentTypes());
    ...
    public void testGenericDocumentParcel_builderCanBeReused() {
        ...
        PropertyParcel stringArrayProperty =
                new PropertyParcel.Builder(/*name=*/ "stringArray")
                        ...
                        .build();
        assertThat(genericDocumentParcel.getParentTypes()).isEqualTo(parentTypes);
        assertThat(genericDocumentParcel.getPropertyMap())
                .containsExactly(
                        "longArray", longArrayProperty, "stringArray", stringArrayProperty);
    }
    ...
    public void testRecreateFromParcelWithParentTypes() {
        ...
        GenericDocumentParcel inDoc =
                new GenericDocumentParcel.Builder("namespace1", "id1", "schema1")
                        ...
                        .putInPropertyMap(
                                ...
                                new GenericDocumentParcel[] {
                                    new GenericDocumentParcel.Builder(
                                            ...
                                            .putInPropertyMap(
                                                    "propStrings", new String[] {"Goodbye"})
        ...
        assertThat(innerDocs[0].getPropertyMap().get("propStrings").getStringValues())
                .isEqualTo(new String[] {"Goodbye"});
        assertThat(innerDocs[0].getPropertyMap().get("propBytes").getBytesValues())
